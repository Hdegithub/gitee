...
import com.newstest.utils.MyBlogUtils;
import com.newstest.utils.NewsConstans;
import com.newstest.utils.Result;
import com.newstest.utils.ResultGenerator;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        File fileDirectory = new File(NewsConstans.FILE_UPLOAD_DIC);
        //创建文件
        File destFile = new File(NewsConstans.FILE_UPLOAD_DIC + newFileName);
        try {
