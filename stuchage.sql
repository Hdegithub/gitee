...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='学生班级表';
...
INSERT INTO `stu_course` VALUES (1,'日语课'),(2,'java课');
...
CREATE TABLE `stu_getday` (
  ...
  `class_id` int(11) DEFAULT NULL,
  `stu_id` int(11) DEFAULT NULL,
  `stu_getady` date DEFAULT NULL,
  `stu_isgetday` int(11) DEFAULT NULL COMMENT '(1)是出勤，（0）是未出勤',
  PRIMARY KEY (`id`)
...
INSERT INTO `stu_getday` VALUES (1,1,1001,'2023-11-21',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='评价表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `stu_leave` WRITE;
/*!40000 ALTER TABLE `stu_leave` DISABLE KEYS */;
INSERT INTO `stu_leave` VALUES (1,1001,'有进步','8','9','7',1),(2,1001,'经常旷课','7','6','5',2);
/*!40000 ALTER TABLE `stu_leave` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `stu_stage`
--

DROP TABLE IF EXISTS `stu_stage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stu_stage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `stage_id` int(11) DEFAULT NULL,
  `stage_name` varchar(45) DEFAULT NULL COMMENT '阶段名称',
...
--
-- Dumping data for table `stu_stage`
--

LOCK TABLES `stu_stage` WRITE;
/*!40000 ALTER TABLE `stu_stage` DISABLE KEYS */;
INSERT INTO `stu_stage` VALUES (1,1,'日语初级',1),(2,2,'java框架',2),(3,3,'日语中级',1),(4,4,'java接口开发',2);
/*!40000 ALTER TABLE `stu_stage` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `stu_table` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='学生信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stu_table` VALUES (12,1001,'jack','女','2001-01-02'),(13,1002,'tom','男','2001-03-02'),(14,1003,'H','男','2001-04-05'),(15,1004,'小刘','男','2003-01-09');
...
-- Dump completed on 2023-11-21 18:15:49
